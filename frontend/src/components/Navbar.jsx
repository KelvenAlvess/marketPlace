...
function Navbar() {
  ...
  const [isCartOpen, setIsCartOpen] = useState(false); // Estado para abrir o carrinho
            ...
            <div className="flex justify-between h-20">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <div className="relative group">
                  <button
                      onClick={() => setIsCartOpen(true)} // <--- Apenas abre o modal
                      className="text-gray-600 hover:text-red-600 transition-colors p-2 relative"
                  >
                    ...
                    {cartItems.length > 0 && (
                        <span className="absolute -top-1 -right-2 bg-red-600 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full animate-bounce">
                ...
                <div className="border-t border-gray-100 my-2 pt-2">
                  {user ? (
                      <>
                        ...
                        <button onClick={() => setIsCartOpen(true)} className="w-full text-left py-3 text-red-600 font-bold hover:bg-red-50 rounded-md px-2 flex items-center gap-2">
